...
export default function ChatRoom({ projectId, projectTitle: propTitle }) {
  ...
  useEffect(() => {
    fetch(`${SOCKET_URL}/chat/room/${projectId}`, { credentials: "include" })
      ...
      .then((data) => {
        ...
        if (!propTitle && data.project_title)
  ...
  const handleRemoveMember = async (memberId, memberName) => {
    ...
    try {
      const res = await fetch(
        `${SOCKET_URL}/projects/${projectId}/members/${memberId}`,
        {
          method: "DELETE",
          credentials: "include",
        },
  ...
  const groupedMessages = messages.reduce((acc, msg, i) => {
    ...
    const within2min =
      prev && new Date(msg.sent_at) - new Date(prev.sent_at) < 2 * 60 * 1000;
    acc.push({
      ...msg,
      showDate: !sameDay,
      showAvatar: !sameSender || !within2min,
    });
    return acc;
  }, []);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          style={{
            ...
            height: 40,
            borderRadius: "50%",
            background: avatarColor(projectId),
            color: "#fff",
            display: "flex",
            alignItems: "center",
        ...
        <div style={{ flex: 1 }}>
          <div
            style={{ fontWeight: 700, fontSize: "0.95rem", color: "#1E2B4A" }}
          >
                    ...
                    <div
                      style={{
                        ...
                        borderRadius: isMine
                          ...
                          : "18px 18px 18px 4px",
                        padding:
                          msg.file_url && !msg.message ? "6px" : "9px 14px",
                        fontSize: "0.88rem",
                        lineHeight: 1.5,
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  ...
                  <div>
                    ...
                    {m.id === ownerId && (
                      <div style={{ fontSize: "0.65rem", color: "#2952A3" }}>
                        Owner
                      </div>
                    )}
                  </div>
      ...
      >
        {showEmoji && (
          <div
            style={{ position: "absolute", bottom: 68, left: 16, zIndex: 100 }}
          >
            <EmojiPicker
              onEmojiClick={(e) => {
        ...
        <input
          ...
          onFocus={(e) => {
            e.target.style.borderColor = "#2952A3";
            setShowEmoji(false);
          }}
          onBlur={(e) => {
            e.target.style.borderColor = "#D0DAEE";
          }}
        />
