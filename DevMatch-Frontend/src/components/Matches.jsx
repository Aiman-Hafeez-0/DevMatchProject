...
function MatchRing({ score }) {
  ...
  return (
    <div style={{ position: "relative", width: 68, height: 68, flexShrink: 0 }}>
      ...
      >
        <span
          style={{ fontWeight: 800, fontSize: "0.9rem", color, lineHeight: 1 }}
        >
          {score}%
        </span>
        <span
          style={{ fontSize: "0.55rem", color: "#8A9BBC", lineHeight: 1.2 }}
        >
          match
        </span>
      </div>
...
export default function Matches() {
  ...
  useEffect(() => {
    fetch("http://localhost:5000/projects/matches", { credentials: "include" })
      .then((r) => r.json())
      .then((data) => {
    ...
    return (
      ...
      >
        ...
        >
          ...
          <h5 style={{ fontWeight: 700, color: "#1E2B4A", marginBottom: 8 }}>
            Set up your skills first
          </h5>
          <p style={{ color: "#8A9BBC", marginBottom: 20 }}>
            Add your skills to your profile so DevMatch can find the best-fit
            projects for you.
          </p>
          <button
            className="btn"
      ...
      <div style={{ maxWidth: 860, margin: "0 auto" }}>
          ...
          >
            <div>
              ...
              <div style={{ fontSize: "0.82rem", opacity: 0.85 }}>
                by {topMatch.owner_name}
              </div>
            </div>
            <div
              style={{ marginLeft: "auto", flexShrink: 0, textAlign: "center" }}
            >
              <div style={{ fontWeight: 800, fontSize: "2rem", lineHeight: 1 }}>
        ...
        {filtered.length === 0 && (
          ...
          >
            ...
            <p style={{ color: "#8A9BBC" }}>
              No projects match that score threshold yet.
            </p>
            <button
