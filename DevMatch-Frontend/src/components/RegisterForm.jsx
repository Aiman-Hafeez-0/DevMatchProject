...
export default function RegisterForm() {
  const [formData, setFormData] = useState({ user_name: '', email_address: '', password: '' });
  ...
  const handleSubmit = async (e) => {
    ...
    if (!user_name || !email_address || !password) { toast.error("Please fill all fields!"); return; }
    ...
    <div style={{
      ...
      <div style={{ width: "100%", maxWidth: 420 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          ...
          <h1 style={{ fontWeight: 800, fontSize: "1.6rem", color: "#1E2B4A", margin: 0 }}>
        ...
        <div style={{
          ...
          <h4 style={{ fontWeight: 700, color: "#1E2B4A", marginBottom: 6 }}>Create an account</h4>
          <p style={{ color: "#8A9BBC", fontSize: "0.85rem", marginBottom: 24 }}>
            Join DevMatch and start collaborating
          </p>

          <form onSubmit={handleSubmit}>
            {[
              { label: "Username", key: "user_name", type: "text", placeholder: "yourhandle" },
              { label: "Email address", key: "email_address", type: "email", placeholder: "you@example.com" },
              ...
              <div style={{ position: "relative" }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    background: "none", border: "none", color: "#bbb", cursor: "pointer", padding: 0,
                  }}
                >
          ...
          <p style={{ textAlign: "center", marginTop: 20, fontSize: "0.88rem", color: "#8A9BBC" }}>
            Already have an account?{" "}
            <Link to="/login" style={{ color: "#2952A3", fontWeight: 600, textDecoration: "none" }}>
              Sign in
            </Link>
          </p>
        </div>
