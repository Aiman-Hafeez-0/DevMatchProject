    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", gap: 10 }}>
          {["Projects", "Matches", "Chats"].map((l) => (
            <span
              key={l}
              style={{ fontSize: 9, color: MUTED, fontWeight: 500 }}
            >
              {l}
            </span>
          ))}
      ...
      <div style={{ padding: 14 }}>
        ...
        >
          ...
          >
            <div>
              <div style={{ fontWeight: 700, fontSize: 11, color: TEXT }}>
                AI Resume Builder
              </div>
  ...
  return (
    <div
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.boxShadow = "0 8px 32px rgba(41,82,163,0.13)";
      }}
      onMouseLeave={(e) => {
        e.currentTarget.style.transform = "none";
        e.currentTarget.style.boxShadow = "0 2px 16px rgba(41,82,163,0.07)";
      }}
    >
      <div
        style={{
    ...
    <div style={{ display: "flex", gap: 20, alignItems: "flex-start" }}>
      <div
        style={{
          ...
          justifyContent: "center",
          flexShrink: 0,
          boxShadow: `0 4px 12px rgba(41,82,163,0.3)`,
        }}
      >
        {num}
      </div>
...
export default function LandingPage() {
  ...
  return (
    ...
    >
          ...
          <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
            ...
            <button
              ...
              style={{
                ...
                boxShadow: "0 2px 8px rgba(41,82,163,0.25)",
              }}
        ...
        >
          ...
          <div style={{ flex: "1 1 420px" }}>
            ...
            >
              ...
              <span style={{ fontSize: "0.78rem", fontWeight: 600, color: P }}>
              ...
              <span style={{ color: P, position: "relative" }}>
                ...
                <span
                  style={{
                    ...
                    right: 0,
                    height: 3,
                    background: `linear-gradient(90deg, ${P}, #4B6FCE)`,
                    borderRadius: 2,
                  }}
                />
              </span>
            ...
            >
              DevMatch connects developers to open-source and collaborative
              projects based on real skill alignment — not just keywords. Join a
              team, contribute, and grow.
            </p>
            ...
            >
              <button
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = PDARK;
              ...
              <button
                ...
                onMouseEnter={(e) =>
                  (e.currentTarget.style.background = PLIGHT)
                }
                onMouseLeave={(e) =>
      ...
      <section
        id="stats"
        style={{ background: "#2952A3", padding: "48px 24px" }}
      >
        <div
          style={{
            maxWidth: 900,
      ...
      >
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 56 }}>
            ...
            >
              Every feature is designed to reduce friction between finding a
              project and contributing to it.
            </p>
          </div>
      ...
      <section
        id="how-it-works"
        style={{ ...DIAMOND_BG, padding: "96px 24px" }}
      >
        <div
          style={{
            maxWidth: 960,
        ...
        >
          <div style={{ flex: "1 1 320px" }}>
            ...
            >
              No tutorials needed. DevMatch is designed to get you building with
            ...
            <button
              ...
              style={{
                ...
                alignItems: "center",
                gap: 8,
                boxShadow: "0 4px 12px rgba(41,82,163,0.25)",
              }}
            >
      ...
      <section
        style={{
          background: `linear-gradient(135deg, ${P} 0%, #4B6FCE 100%)`,
          padding: "80px 24px",
          textAlign: "center",
        }}
      >
        ...
        >
          Join DevMatch and start collaborating on projects that actually match
          your skills.
        </p>
        <div
          style={{
          ...
          >
            {[
              ...
              <a
                ...
                onMouseEnter={(e) => (e.target.style.color = "#A0B3DF")}
                onMouseLeave={(e) =>
